...
class ReleaseMetadataTests(unittest.TestCase):
                ...
                'packages': [{
                    ...
                    'externalRefs': [{
                        ...
                        'referenceLocator': (
                            ...
                            '?repository_url=docker.io&tag=0.2.5'),
                    }],
                }],
                'relationships': [{
    ...
    def test_builds_deterministic_inventory_sbom_and_checksums(self):
        ...
        self.assertIn('algosec-jira-bus-0.2.5-sbom.spdx.json', first['artifacts'])
    ...
    def test_rejects_an_invalid_adjacent_checksum(self):
        ...
        checksum.write_text('0' * 64 + '  algosec-jira-bus-0.2.5-linux.run\n')

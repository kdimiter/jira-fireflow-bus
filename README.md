...
asks for a password without echoing or logging it. Use a unique password generated by your
password manager. `prepare-jira.sh` creates or discovers the company-managed

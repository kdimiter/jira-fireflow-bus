...
```sh
# 1. Download these two assets from release v0.3.1, then verify and run:
...
Download: [GitHub Release v0.3.1](https://github.com/kdimiter/jira-fireflow-bus/releases/tag/v0.3.1).

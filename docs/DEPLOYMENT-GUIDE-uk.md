...
type scheme містить лише вибраний інтеграційний тип і робить його типовим у вікні Create. Повторний
запуск відновлює цей default, якщо його змінили в Jira. Автоматичне призначення схем виконується
